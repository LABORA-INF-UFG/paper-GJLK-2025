...
for timestamp in x:
    ...
    y_optimal.append(json_obj["solution"]["Total_Cost"])
    ...
    y_single_path.append(json_obj["solution"]["Total_Cost"])
    ...
    y_unconstrained.append(json_obj["solution"]["Total_Cost"])
...
plt.ylim(0, 1599)
# plt.legend()
plt.yticks([_ for _ in range(0, 1601, 200)], fontsize=fontsize)
